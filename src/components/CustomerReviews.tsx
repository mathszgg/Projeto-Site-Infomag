...
const CustomerReviews = () => {
    return (
        <div className="bg-secondary-color text-white flex flex-col items-center gap-7">
            ...
            <ScrollAnimation className="w-11/12 max-w-7xl grid grid-cols-1 md:grid-cols-3 justify-center items-center gap-5 lg:gap-10 mx-4" direction="bottom">
                {reviews.map((item, index) => (
                    <div key={index} className="w-full transition-all bg-primary-color shadow-lg flex flex-col gap-3 p-5 rounded-lg hover:scale-105 hover:bg-green-700 hover:shadow-xl shadow-gray-400">
